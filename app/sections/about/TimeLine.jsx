...
const TimeLineData = [
	{ year: 2023, text: "Pretty excited to learn new things on the go.TECHNOLOGIES" },
	{ year: 2021, text: "I started freelancing in my free time." },
	{ year: 2020, text: "Started my journey as Frontend developer" }
];
